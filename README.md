...
*Desarrollador Móvil | Estudiante de Ingeniería en Software*

<!--Start Intro-->               
<p align="left">
Soy un estudiante de Ingeniería en Software con especialización en desarrollo de aplicaciones móviles utilizando <strong>Flutter</strong>. También tengo conocimientos en varias tecnologías como <strong>Python, Dart, JavaScript, PostgreSQL, MySQL, Firebase, Django, SQL Server, Git, Postman</strong> y más. Me apasiona construir soluciones útiles y aprender constantemente sobre nuevas herramientas y metodologías.
</p>

- 📱 Apasionado por las apps móviles modernas y eficientes.
- 🌱 En constante aprendizaje, cada día es una oportunidad para mejorar.
- 💡 Interesado en el backend, las APIs REST y la integración de servicios.
...
<p align="center">
<img width="500px"  src="https://skillicons.dev/icons?i=flutter,dart,py,js,html,css,django,firebase,postgres,mysql,sqlite,git,github,linux,vscode,postman"  />
</p>
<br />
